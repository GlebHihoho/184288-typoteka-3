...
const define = (sequelize) => {
  ...
  Category.hasMany(ArticleCategory, {as: Aliase.ARTICLES_CATEGORIES, foreignKey: `categoryId`});
  Article.hasMany(ArticleCategory, {as: Aliase.ARTICLES_CATEGORIES, foreignKey: `articleId`});
